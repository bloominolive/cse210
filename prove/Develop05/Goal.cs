public class Goal {
    ...
    public string GetGoalTitle() {return _goalTitle;}
    public string GetGoalDescription() {return _goalDescription;}
    public int GetPointsForGoal() {return _pointsForGoal;}
    public bool GetGoalIsAcheived() {return _goalIsAchieved;}
    public GoalTypes GetGoalType() {return _type;}    
}